...
| 27B decode exact, 12.5 t/s; MTP 35.6 t/s | `./build.sh "./build/run27b $B27 docs/ref/code.json"`, `./build.sh "./build/spec27b $B27 docs/ref/code.json 64 5"` | `12/12`, then `EXACT: 64/64`, `mtp n=5: … ~35 t/s` |
