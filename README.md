...
| **27B DFlash2 exact, 54 t/s on code** (22 on prose) | `./build.sh "./build/dflash27b $B27 models/Qwen3.8-27B-DFlash2-Q4_K_M.gguf docs/ref/code.json 96 7"` (draft GGUF: see docs/speculative-27b.md) | `dflash2 n=7: … ~54 t/s`, `EXACT: 96/96` |
