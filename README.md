...
| **27B DFlash2 × 2 slots, 78 t/s aggregate, both exact** | `./build.sh "SLOTS=2 ./build/dflash27b $B27 models/Qwen3.8-27B-DFlash2-Q4_K_M.gguf docs/ref/code.json 96 7"` | `dflash2 x 2 slots: … ~78 t/s aggregate`, `EXACT: 2 slots identical to plain greedy` |
