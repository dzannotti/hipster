...
| **27B DFlash2 × 2 slots, 85 t/s aggregate, both exact** | `./build.sh "SLOTS=2 ./build/dflash27b $B27 models/Qwen3.8-27B-DFlash2-Q4_K_M.gguf docs/ref/code.json 96 7"` | `dflash2 x 2 slots: … ~85 t/s aggregate`, `EXACT: 2 slots identical to plain greedy` |
| **27B DFlash2 exact, 52 t/s on code** (22 on prose) | `./build.sh "./build/dflash27b $B27 models/Qwen3.8-27B-DFlash2-Q4_K_M.gguf docs/ref/code.json 96 7"` (draft GGUF: see docs/speculative-27b.md) | `dflash2 n=7: … ~52 t/s`, `EXACT: 96/96` |
