...
| 27B served (OpenAI endpoint, DFlash2), 46 t/s on a 200-token code reply | `MODEL=$B27 DRAFT=models/Qwen3.8-27B-DFlash2-Q4_K_M.gguf tools/serve.sh --ctx 8192` then a chat completion (docs/serving.md) | `timings.predicted_per_second ≈ 46` |
