...
| Flash-Next served with 4 slots: 50 t/s aggregate for four concurrent requests, each identical to its solo output | `tools/serve.sh --ctx 8192 --slots 4` then four concurrent chat completions (docs/serving.md) | 647 tokens in ~13 s wall |
